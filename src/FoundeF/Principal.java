...
public class Principal {
	...
	public static void main(String[] args) {
		...
		final int m = 3;
		final int p = 2;
		final int unitatsCarn = 5;
		final int unitatsFormatge = 3;
		Random random = new Random();
		
		Tenedors carn = new Tenedors(m,"carn",unitatsCarn);
		Tenedors formatge = new Tenedors(p,"formatge",unitatsFormatge);
		for (int i = 0; i < n; i++) {
